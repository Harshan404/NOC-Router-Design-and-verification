...
REM
REM Generated by Vivado on Sat Sep 06 11:48:11 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_all_modules_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_all_modules_vlog.prj -log xvlog.log
