...
REM
REM Generated by Vivado on Sun Aug 31 19:27:05 +0530 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_noc_router_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_noc_router_vlog.prj -log xvlog.log
